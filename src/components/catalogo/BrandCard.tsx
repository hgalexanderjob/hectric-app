...
import { Brand } from "@/app/catalogo/data";
        ...
        <ul className="p-2 space-y-1">
          {brand.series.map((serie) => (
            <li key={serie.name}>
              <Link
                href={serie.href}
                className="p-3 text-sm text-slate-600 hover:bg-slate-100 rounded-lg cursor-pointer flex justify-between items-center border border-transparent hover:border-slate-200 transition-all font-medium group/serie"
              >
